...
// 		? Unwrap<_<T[Key]>>
// 		: _<T[Key]>;
// } extends infer Some extends Record<string, _<EnumValue>>
// 	? Some & {
// 			keys(): Array<keyof T>;

// 			values<B extends false | undefined = undefined>(
// 				_branded?: B,
// 			): Array<Values<Some, B>>;

// 			entries<B extends false | undefined = undefined>(
// 				_branded?: B,
// 			): Array<
// 				{ [Key in keyof Some]: [Key, Values<Pick<Some, Key>, B>] }[keyof Some]
// 			>;

// 			mirror(): {
// 				readonly [Key in keyof Some as Unwrap<Some[Key]>]: Key;
// 			};

// 			getKey<
// 				V extends Values<Some, Branded>,
// 				Branded extends false | undefined = undefined,
// 			>(
// 				value: V,
// 				_branded?: Branded,
// 			): {
// 				[Key in keyof Some as Some[Key] extends V ? Key : never]: Key;
// 			} extends Record<string, infer R>
// 				? R
// 				: undefined;
// 		} & {
// 			KeysType: Keys<Some>;
// 			ValuesType: Values<Some>;
// 			// EntriesType: Entries<Some>;
// 		}
// 	: never {
